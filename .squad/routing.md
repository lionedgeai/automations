...
|-----------|----------|----------|
| Architecture & scope | Morpheus | System design, Docker architecture, API design, scope decisions |
| Backend / n8n | Trinity | n8n setup, Docker Compose, workflow config, API integration, Salesforce/SMS/CRM connectors |
| Frontend / UI | Tank | Custom UI, React components, webhook client, status display |
| Code review | Morpheus | Review PRs, check quality, suggest improvements |
| Testing | Switch | Write tests, find edge cases, verify e2e flows, API contract tests |
